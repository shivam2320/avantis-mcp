...
export const UpdateTpAndSLSchema = {
  from: z
    .string()
    .describe(
...
export const ModifyTradeSchema = {
  ...
  _amount: z
    ...
    _type: z
      ...
      .default("0")
      .describe(
        "The type of modification to perform: 'add' to increase the position, 'remove' to decrease the position, 0 if add collateral and 1 if withdraw collateral"
      ),
};
